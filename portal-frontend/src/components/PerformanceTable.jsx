        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-gray-50/50">
              ...
              <th className="px-8 py-4 text-[10px] font-black text-secondary uppercase tracking-widest">Avg Time (Hrs)</th>
          ...
          <tbody className="divide-y divide-gray-50">
            {data.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50/30 transition-colors">
                ...
                <td className="px-8 py-5 text-sm font-medium text-secondary">{item.active}</td>
                <td className="px-8 py-5 text-sm font-medium text-secondary">{item.avg_resolution_time}</td>
