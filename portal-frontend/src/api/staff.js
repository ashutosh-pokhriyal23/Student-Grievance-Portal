...
export const getStatuses = async () => (await api.get('/staff/statuses')).data;
export const updateComplaintStatus = async (id, data) => (await api.patch(`/staff/complaints/${id}/status`, data)).data;
